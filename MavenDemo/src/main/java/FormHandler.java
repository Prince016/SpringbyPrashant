...
//	         
//	         Connection con = DriverManger.getConnection("jdbc:mysql://localhost:3306/app","root","prashant@328");
//	         
////	         Class.forName(com.mysql.cj.jdbc.Driver)
//	         
//	         
...
//	        
//	        if(record ==1) {
//	        	out.println("<h2> Recorded Inserted Successfully </h2>");
//	        	}
//	        else {
//	        	out.println("<h2> Error.. adding recored  </h2>");
//	        
//	        	 out.println("</body></html>");
//	        
//	        }
